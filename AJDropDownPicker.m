...
#define backColor [UIColor colorWithRed:100.0/255.0 green:100.0/255.0 blue:100.0/255.0 alpha:1]
...
- (id)initWithDelegate:(id)delegate dataSourceArray:(NSArray *)dataSourceArray
{
    ...
    if (self) {
        ...
        pickerTableView.layer.borderColor = [UIColor whiteColor].CGColor;
        pickerTableView.layer.borderWidth = 1.0;
        
        pickerTableView.backgroundColor = [UIColor whiteColor];
        pickerTableView.separatorColor  = [UIColor whiteColor];
